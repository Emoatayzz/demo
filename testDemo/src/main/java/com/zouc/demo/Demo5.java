...
public class Demo5 {
	public static void main(String[] args) {
		...
		// String s3 = "###580dc78423a4b7fe9225ca5b3d1e1292###50106###Windows Server 2008 R2 Enterprise###12810\\tSecurity\\t3216028\\t1596161460\\t5156\\tMicrosoft-Windows-Security-Auditing\\tnull\\t8\\texpsecretapp1\\t(12810)\\tWindows 筛选平台已允许连接。\\r\\n\\r\\n应用程序信息:\\r\\n\\t进程 ID:\\t\\t4516\\r\\n\\t应用程序名称:\\tdeviceharddiskvolume3program files (x86)tpmserverv3webplatformjavaservice.exe\\r\\n\\r\\n网络信息:\\r\\n\\t方向:\\t\\t%%14593\\r\\n\\t源地址:\\t\\t10.9.2.31\\r\\n\\t源端口:\\t\\t57579\\r\\n\\t目标地址:\\t192.168.146.239\\r\\n\\t目标端口:\\t\\t9092\\r\\n\\t协议:\\t\\t6\\r\\n\\r\\n筛选器信息:\\r\\n\\t筛选器运行时 ID:\\t69673\\r\\n\\t层名称:\\t\\t%%14611\\r\\n\\t层运行时 ID:\\t48";
